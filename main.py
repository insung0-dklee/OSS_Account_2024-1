...
def average():
    ...
    print(f"한달 평균 생활비는 {평균_생활비[연령대]:,}원 입니다.")
    print(f"한달 평균 월급은 {평균_월급[연령대]:,}원 입니다.")

    if 월급 > 평균_월급[연령대]:
        print("평균보다 높은 월급을 벌고 계시네요!")
    else:
        print("현재 월급은 평균보다 낮습니다. 파이팅!!")
"""   
나이를 입력받고 한국 1인 평균 생활비와 월급을 보여주고, 평균 기준에 따라 서로 다른 메시지를 출력해주는 기능    
"""     
