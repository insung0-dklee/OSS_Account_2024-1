...
def print_help():
    ...
    7: 사용자가 입력한 단어에 대한 조언 출력
    8: 사용자가 입력한 숫자와 관련있는 유익한 내용 출력
    9: 입력한 분야에 대한 투자 성공 스토리 출력
    ?: 도움말 출력
...
# 사용자가 입력한 키워드에 대한 조언을 출력
def financial_advice():
    
    word = input("특정 단어를 입력하세요: ")
    
    messages = {
        "저축": "저축하는 습관이 미래의 당신을 더욱 풍요롭게 만듭니다.",
        "투자": "투자는 장기적인 안목으로! 작은 투자도 큰 수익으로 돌아올 수 있습니다.",
        "신용": "좋은 신용 점수는 더 나은 금융 생활을 위한 첫걸음입니다.",
        "예산": "효과적인 예산 관리는 재정 건강의 핵심입니다. 계획적으로 지출하세요!",
        "목표": "구체적인 재정 목표를 설정하고 차근차근 실천해 나가세요!",
        "지출": "지출을 꼼꼼히 기록하고 분석하면, 불필요한 소비를 줄일 수 있습니다.",
        "수입": "수입을 잘 관리하고, 추가 수입원을 찾아보세요!",
        "부채": "부채 관리는 재정 건강의 핵심입니다. 가능한 한 빨리 부채를 상환하고, 부채를 줄여나가세요.",
        "소득": "소득을 효율적으로 관리하여 재정 목표를 달성하세요. 추가 소득원을 찾아보는 것도 좋은 방법입니다.",
        "지출": "지출을 꼼꼼하게 기록하고 분석하여 불필요한 소비를 줄이세요. 현명한 지출이 재정 건강을 지키는 첫걸음입니다.",
        "예산": "효과적인 예산 관리는 재정 건강의 핵심입니다. 계획적으로 지출하고 예산을 준수하세요.",
        "목표": "구체적인 재정 목표를 설정하고, 그 목표를 달성하기 위한 계획을 세우세요. 작은 목표부터 시작해보세요.",
        "저금": "저금은 미래를 위한 준비입니다. 꾸준한 저축 습관을 길러 재정 안정을 도모하세요.",
        "재무": "재무 관리를 체계적으로 하여 재정 건강을 지키세요. 자산과 부채를 정기적으로 점검하세요.",
        "현금흐름": "건강한 현금흐름은 재정 안정의 기초입니다. 수입과 지출을 균형 있게 관리하세요.",
        "연금": "안정된 노후를 위해 연금을 꾸준히 관리하세요. 지금부터 준비하는 것이 중요합니다.",
        "부동산": "부동산 투자는 장기적인 안목으로 접근하세요. 시장 동향을 잘 파악하고 신중히 투자하세요.",
        "크레딧": "신용 점수를 관리하여 더 나은 금융 조건을 확보하세요. 신용 카드 사용에 주의하세요.",
        "대출": "대출은 신중하게 선택하고, 상환 계획을 철저히 세우세요. 가능한 한 빨리 상환을 완료하세요."
    }

    print(messages.get(word, "해당 키워드에 대한 메시지가 없습니다."))


# 특정 숫자에 대한 유익한 사실 중 하나를 리턴
def fact_about_numbers(number):
    facts = {
	    50: "50% 규칙을 들어보셨나요? 수입의 50%를 필수 지출에 사용하고, 나머지를 저축과 여가에 분배해 보세요.",
        503020: "50/30/20 규칙을 기억하세요: 50%는 필수 지출, 30%는 자유 지출, 20%는 저축과 부채 상환에 사용하세요.",
        10: "매월 소득의 10%를 저축하면, 긴급 상황에서 대비할 수 있는 훌륭한 비상금을 만들 수 있습니다.",
        6: "비상금은 최소 6개월치 생활비를 준비하는 것이 좋습니다. 예기치 않은 상황에 대비하세요.",
        72: "72의 법칙: 투자금이 두 배가 되는 데 걸리는 시간은 72를 연이율로 나눈 값입니다.",
        30: "30일 규칙: 큰 지출을 하기 전에 30일 동안 생각해 보세요. 꼭 필요한 지출인지 다시 한번 고민해보세요.",
        80: "80/20 법칙: 지출의 80%는 소득의 20%에서 발생합니다. 주요 지출 항목을 점검해보세요.",
        5000: "하루에 5000원을 절약하면, 1년 후에는 180만원을 절약할 수 있습니다. 작은 습관이 큰 차이를 만듭니다.",
        25: "25의 법칙: 연간 지출의 25배를 모으면 은퇴 후 생활비를 충당할 수 있습니다.",
        5: "매일 5분만 투자해서 지출 내역을 기록하세요. 꾸준한 기록이 재정 건강을 지킵니다.",
        3: "3의 법칙: 세 가지 지출 항목을 정해서 매달 예산을 절약해보세요. 작은 변화가 큰 효과를 가져옵니다."
    }

    return facts.get(number, "해당 숫자에 대한 내용이 없습니다.")

# 특정 숫자를 입력받아 그 수에 대한 사실 출력
def print_fact_about_number():
    number = int(input("특정 숫자를 입력하세요: "))
...
# 투자 성공 스토리 저장 및 선택
def investment_success_story(field):
    stories = {
        "주식": (
            "워렌 버핏은 세계에서 가장 성공적인 투자자로 알려져 있습니다. "
            "버핏은 11세 때 첫 주식을 샀고, 30대 초반에는 버크셔 해서웨이란 직물 회사를 인수했습니다. "
            "그 후로 버크셔 해서웨이를 통해 다양한 회사를 인수하고 투자하면서 엄청난 자산을 쌓았습니다. "
            "버핏의 투자 철학은 가치 투자를 기반으로 하며, 회사의 내재 가치를 분석하여 "
            "장기적으로 우량 주식을 보유하는 전략을 사용합니다. "
            "그 결과, 버크셔 해서웨이의 주가는 수십 년간 꾸준히 상승하며 주주들에게 막대한 수익을 안겨주었습니다."
        ),
        "부동산": (
            "도널드 브렌은 미국의 가장 성공적인 부동산 개발자 중 한 명입니다. "
            "브렌은 1977년에 어바인 컴퍼니를 인수했으며, "
            "이 회사는 이후 캘리포니아 남부에서 가장 큰 부동산 개발 업체 중 하나가 되었습니다. "
            "브렌의 성공 비결은 장기적인 안목과 지속 가능한 도시 개발에 대한 관심이었습니다. "
            "그는 어바인 컴퍼니를 통해 주거, 상업, 오피스 공간을 개발하며 엄청난 부를 축적했습니다."
        ),
        "암호화폐": (
            "비탈릭 부테린은 이더리움의 공동 창시자로, 암호화폐 업계에서 큰 성공을 거둔 인물입니다. "
            "부테린은 2013년에 이더리움 프로젝트를 제안했으며, "
            "2015년에 이더리움 네트워크가 출시되었습니다. "
            "이더리움은 스마트 계약 기능을 통해 다양한 분산 애플리케이션(dApp)을 가능하게 했으며, "
            "이는 암호화폐와 블록체인 기술의 혁신을 이끌었습니다. "
            "부테린의 비전과 기술적 혁신은 그와 이더리움에 큰 성공을 가져다주었습니다."
        ),
        "펀드": (
            "피터 린치는 세계적인 펀드 매니저로, 피델리티 매지ellan 펀드를 운영하면서 "
            "연평균 29%의 수익률을 기록했습니다. "
            "린치는 1977년부터 1990년까지 펀드를 운영하며, 투자자들에게 막대한 수익을 안겨주었습니다. "
            "그의 투자 철학은 '투자할 때 이해할 수 있는 회사에 투자하라'는 원칙을 기반으로 하며, "
            "철저한 기업 분석과 장기적인 안목을 강조합니다."
        ),
        "채권": (
            "빌 그로스는 '채권의 왕'으로 불리며, 세계적인 채권 투자자로 명성을 쌓았습니다. "
            "그로스는 피앤드지(PIMCO)의 공동 설립자로, 회사의 총괄 투자 책임자로 활동하며 "
            "수십 년간 수백억 달러 규모의 채권 포트폴리오를 관리했습니다. "
            "그는 채권 시장에서 뛰어난 성과를 거두며, 투자자들에게 안정적이고 높은 수익을 제공했습니다."
        )
    }

    return stories.get(field, "해당 분야에 대한 투자 성공 이야기가 없습니다.")


# 사용자 입력에 따라 투자 성공 이야기 출력
def print_investment_success_story():
    user_input = input("원하는 투자 분야를 입력하세요 (주식, 부동산, 암호화폐, 펀드, 채권): ")
    print(investment_success_story(user_input))
...
while not b_is_exit:
    ...
    if func == "1":
        ...
        print_fact_about_number()
    elif func == "9":
        print_investment_success_story()
    elif func == "?":
        print_help()
