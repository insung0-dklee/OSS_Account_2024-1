# 카테고리별 지출 비용 계산 및 지출 증가 경고메시지 기능
import datetime
...
# 추가 기능 테스트
account_book.category_spending_ratio()
account_book.recent_transactions(3)
account_book.projected_balance(6)
